...
or with uv
uv run --with simple-ddl-parser convertor.py postgres ../mysql/02-ruoyi-vue-pro.sql > ../postgresql/02-ruoyi-vue-pro.sql
uv run --with simple-ddl-parser convertor.py sqlserver ../mysql/02-ruoyi-vue-pro.sql > ../sqlserver/02-ruoyi-vue-pro.sql
uv run --with simple-ddl-parser convertor.py kingbase ../mysql/02-ruoyi-vue-pro.sql > ../kingbase/02-ruoyi-vue-pro.sql
uv run --with simple-ddl-parser convertor.py opengauss ../mysql/02-ruoyi-vue-pro.sql > ../opengauss/02-ruoyi-vue-pro.sql
uv run --with simple-ddl-parser convertor.py oracle ../mysql/02-ruoyi-vue-pro.sql > ../oracle/02-ruoyi-vue-pro.sql
uv run --with simple-ddl-parser convertor.py dm8 ../mysql/02-ruoyi-vue-pro.sql > ../dm/ruoyi-vue-pro-dm8.sql
"""
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        help="源数据库脚本路径",
        default="../mysql/02-ruoyi-vue-pro.sql"
    )
